...
$hostDirectory = Join-Path -Path $rootDirectory -ChildPath 'src/Briefly/app'
$infrastructurePrj = Join-Path -Path $rootDirectory -ChildPath 'src/Briefly/app/Briefly.Client.Infrastructure/Briefly.Client.Infrastructure.csproj'
